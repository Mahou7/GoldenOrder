...
(function () {
  const DICT = {
    pt: {
      ...
      'invite.sealNumberLabel': 'Convite Nº',
      'invite.sealValidLabel': 'Válido até',
      'btn.accept': 'Aceitar',
      'btn.decline': 'Recusar',
    ...
    en: {
      ...
      'invite.sealNumberLabel': 'Invite No.',
      'invite.sealValidLabel': 'Valid until',
      'btn.accept': 'Accept',
      'btn.decline': 'Decline',
    ...
    es: {
      ...
      'invite.sealNumberLabel': 'Invitación Nº',
      'invite.sealValidLabel': 'Válido hasta',
      'btn.accept': 'Aceptar',
